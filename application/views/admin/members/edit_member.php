                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="<?= $m['username']; ?>" name="username" placeholder="Username" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-3 col-form-label">Nama Konsumen</label>
                                    <div class="col-sm-9">
                                        <input type="text" value="<?= $m['namaKonsumen']; ?>" name="namaKonsumen" placeholder="Nama Konsumen" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="kota">
                                            <?php foreach ($city as $c) : ?>
                                                <option value="<?= $m['idKota'] ?>"><?= $c['namaKota'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" value="<?= $m['alamat']; ?>" name="alamat" placeholder="Alamat" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-3 col-form-label">Email</label>
                                    <div class="col-sm-9">
                                        <input type="text" value="<?= $m['email']; ?>" name="email" placeholder="Email" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-3 col-form-label">Password</label>
                                    <div class="col-sm-9">
                                        <input type="password" value="<?= $m['password']; ?>" name="password" placeholder="Password" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword3" class="col-sm-3 col-form-label">No Telepon</label>
                                    <div class="col-sm-9">
                                        <input type="number" value="<?= $m['tlpn']; ?>" name="tlpn" placeholder="Nomor Telepon" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="statusAktif" class="form-control">
                                            <option value="<?= $m['statusAktif']; ?>"></option>
